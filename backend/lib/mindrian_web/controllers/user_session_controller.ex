defmodule MindrianWeb.UserSessionController do
  ...
  def new(conn, params) do
    ...
    # Store return_to URL if provided (for cross-origin dev mode)
    conn =
      case params["return_to"] do
        url when is_binary(url) and url != "" -> put_session(conn, :user_return_to, url)
        _ -> conn
      end
  ...
  # GET logout for SPA (alternative to DELETE for simpler client-side handling)
